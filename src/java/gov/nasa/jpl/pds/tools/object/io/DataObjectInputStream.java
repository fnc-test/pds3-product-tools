...
package gov.nasa.jpl.pds.tools.object.io;

import gov.nasa.jpl.pds.tools.label.PointerStatement;
...
public class DataObjectInputStream {
    public DataObjectInputStream(PointerStatement pointer) {
        //FIXME: Fill in code. Only a class definition right now.
    }
}
