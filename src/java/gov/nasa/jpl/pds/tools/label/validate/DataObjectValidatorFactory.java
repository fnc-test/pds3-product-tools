...
import gov.nasa.jpl.pds.tools.label.parser.UnsupportedTypeException;
...
public class DataObjectValidatorFactory {
     ...
     */
    public DataObjectValidator createInstance(String type) throws UnsupportedTypeException {
