...
public interface PointerType {
    ...
    public final static String [] CATALOG_NAMES = {"DATA_SET_CATALOG", "DATA_SET_COLLECTION_CATALOG",
    	"INSTRUMENT_CATALOG", "INSTRUMENT_HOST_CATALOG", "MISSION_CATALOG", "DATA_SET_MAP_PROJECTION_CATALOG",
    	"PERSONNEL_CATALOG", "REFERENCE_CATALOG", "SOFTWARE_CATALOG", "TARGET_CATALOG"};
