...
public class ElementDefinitionTest extends TestCase {
    ...
    public void testCtor() {
        ...
        assertEquals(new Double(Double.MIN_VALUE), new Double(definition.getMinimum()));
        assertEquals(new Double(Double.MAX_VALUE), new Double(definition.getMaximum()));
    }
    ...
    public void testSetters() {
        ...
        assertEquals("TEST", definition.getValues().get(0));
        
        assertEquals(new Double(Double.MIN_VALUE), new Double(definition.getMinimum()));
        definition.setMinimum(10);
        assertEquals(new Double(10), new Double(definition.getMinimum()));
        
        assertEquals(new Double(Double.MAX_VALUE), new Double(definition.getMaximum()));
        definition.setMaximum(10);
        assertEquals(new Double(10), new Double(definition.getMaximum()));
    }
}
