 ...
 * 
 */
public class AlphabetChecker extends LengthChecker implements TypeChecker {
     ...
     *             if the value can not be interpreted as Alphabet
     * 
    ...
    public Object cast(String value, AttributeStatement attribute)
            throws InvalidTypeException {
        if (!value.matches("[a-zA-Z]*")) //$NON-NLS-1$
            throw new InvalidTypeException(attribute,
                    "parser.error.nonAlphabetic", value); //$NON-NLS-1$
        return value;
    }
